...
async def generate_from_template(
    ...
    try:
        ...
        logger.error(f"❌ Template generation endpoint error: {e}")
        raise HTTPException(
            status_code=500,
...
async def process_template_generation(generation_id: str, request: TemplateGenerationRequest, customer_id: str):
    ...
    try:
        print(f"🔍 DEBUG: Starting template generation {generation_id}")
        ...
        for source_metadata in source_files_metadata:
            ...
            if file_path_to_read:
                try:
                    ...
                    print(f"⚠️ Error reading file {file_path_to_read}: {e}")
